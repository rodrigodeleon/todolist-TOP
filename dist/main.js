...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE;wEACsE;AACxE;AACA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,iBAAiB;AACnB;;AAEA;EACE,cAAc;EACd,gBAAgB;EAChB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,gBAAgB;EAChB,SAAS;EACT,kBAAkB;EAClB,aAAa;AACf;;AAEA;EACE,mBAAmB;EACnB,gBAAgB;AAClB;;AAEA;EACE,6BAA6B;EAC7B,gBAAgB;EAChB,kBAAkB;EAClB,aAAa;EACb,kBAAkB;EAClB,wBAAwB;EACxB,0BAA0B;EAC1B,kBAAkB;AACpB;;AAEA;CACC,YAAY;AACb;;AAEA;EACE,eAAe;EACf,iBAAiB;EACjB,WAAW;AACb;;AAEA;EACE,SAAS;EACT,aAAa;EACb,UAAU;EACV,eAAe;EACf,mBAAmB;EACnB,UAAU;EACV,SAAS;EACT,QAAQ;EACR,kBAAkB;EAClB,mBAAmB;EACnB,cAAc;EACd,kBAAkB;EAClB,mBAAmB;EACnB,mBAAmB;EACnB,iBAAiB;EACjB,4BAA4B;EAC5B,sBAAsB;EACtB,iBAAiB;EACjB,YAAY;AACd;AACA;EACE,YAAY;EACZ,kBAAkB;EAClB,kBAAkB;EAClB,4BAA4B;EAC5B,cAAc;EACd,oBAAoB;EACpB,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,gBAAgB;EAChB,WAAW;EACX,aAAa;EACb,sBAAsB;EACtB,oBAAoB;AACtB;;AAEA;EACE,iBAAiB;EACjB,sBAAsB;EACtB,eAAe;EACf,yBAAyB;AAC3B;;AAEA;;;;;;EAME,kBAAkB;EAClB,qBAAqB;EACrB,eAAe;AACjB","sourcesContent":["body {\n  font-family: system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto,\n    Oxygen, Ubuntu, Cantarell, \"Open Sans\", \"Helvetica Neue\", sans-serif;\n}\n#content {\n  display: flex;\n}\n\n#actions {\n  padding: 2rem;\n  font-size: larger;\n}\n\n#projectSelector {\n  margin: 0 1rem;\n  font-size: large;\n  padding: 0.5rem;\n}\n\n.projectList {\n  display: flex;\n  flex-direction: column;\n  list-style: none;\n  gap: 2rem;\n  padding-left: 2rem;\n  margin-top: 0;\n}\n\n.projName {\n  font-weight: bolder;\n  font-size: large;\n}\n\n.todoList {\n  padding: 0.5rem 0 1rem 0.5rem;\n  list-style: none;\n  width: fit-content;\n  display: flex;\n  text-align: center;\n  border-bottom-width: 1px;\n  border-bottom-style: solid;\n  border-color: gray;\n}\n\n.projectDiv:last-child ul{\n border: none;\n}\n\n.todoShortDescription {\n  padding: 0.5rem;\n  font-size: medium;\n  width: 8rem;\n}\n\n.modal {\n  gap: 2rem;\n  display: flex;\n  flex: auto;\n  position: fixed;\n  align-items: center;\n  z-index: 1;\n  left: 20%;\n  top: 20%;\n  width: fit-content;\n  height: fit-content;\n  overflow: auto;\n  border-radius: 8px;\n  border-style: solid;\n  border-color: white;\n  border-width: 2px;\n  background-color: dodgerblue;\n  padding: 0 1rem 0 2rem;\n  font-weight: bold;\n  color: white;\n}\n.btnDetails {\n  color: white;\n  border-radius: 8px;\n  border-style: none;\n  background-color: dodgerblue;\n  margin: 0.5rem;\n  padding: 0.5rem 1rem;\n  height: fit-content;\n}\n.modalText {\n  padding: 1rem;\n  min-width: 10rem;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  font-weight: lighter;\n}\n\n.close {\n  text-align: right;\n  align-self: flex-start;\n  font-size: 28px;\n  margin: 0.3rem 0 0 0.7rem;\n}\n\n.close:hover,\n.close:focus,\n.delete:hover,\n.delete:focus,\n.btnDetails:hover,\n.btnDetails:focus {\n  color: yellowgreen;\n  text-decoration: none;\n  cursor: pointer;\n}\n"],"sourceRoot":""}]);
// Exports
...
function populateProjectSelector(selectorHtmlLocationId) { //populates a targeted select item
  const projectSelector = document.querySelector(`#${selectorHtmlLocationId}`);
...
function newTask (){
  ...
  taskModal.append(createTask, closeButton);
...
class ToDo {
  constructor(title, description, dueDate, priority) {
    ...
    this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dueDate, "P");
