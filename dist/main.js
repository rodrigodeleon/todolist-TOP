...
function loadMenu() {
  ...
  updateProjectSelector("projectSelector");
  ...
  actions.append(buttonNewProject);
  loadProjects(allprojects);
}

function updateProjectSelector(selectorHtmlLocationId) {
