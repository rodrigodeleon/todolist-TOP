...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,mBAAmB;EACnB,UAAU;AACZ;AACA;EACE,aAAa;EACb,kBAAkB;EAClB,gBAAgB;AAClB;AACA;EACE,aAAa;EACb,4BAA4B;AAC9B;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,UAAU;EACV,eAAe;EACf,UAAU;EACV,SAAS;EACT,QAAQ;EACR,sBAAsB;EACtB,mBAAmB;EACnB,cAAc;EACd,kBAAkB;EAClB,kBAAkB;EAClB,2BAA2B;EAC3B,cAAc;;AAEhB;AACA;IACI,eAAe;IACf,aAAa;IACb,sBAAsB;IACtB,YAAY;IACZ,YAAY;IACZ,mJAAmJ;AACvJ;AACA;IACI,UAAU;IACV,kBAAkB;AACtB;AACA;EACE,YAAY;EACZ,iBAAiB;EACjB,eAAe;EACf,iBAAiB;EACjB,yBAAyB;AAC3B;;AAEA;;EAEE,YAAY;EACZ,qBAAqB;EACrB,eAAe;AACjB","sourcesContent":["#content {\n  display: flex;\n}\n\n.project {\n  display: flex;\n  flex-direction: column;\n}\n\n.projName {\n  font-weight: bolder;\n  padding: 0;\n}\nul {\n  display: flex;\n  width: fit-content;\n  list-style: none;\n}\nli {\n  padding: 1rem;\n  border-right: 1px solid #ccc;\n}\n\nli:last-child {\n  border-right: none;\n}\n\n.modal {\n  display: flex;\n  flex: auto;\n  position: fixed; \n  z-index: 1;\n  left: 25%;\n  top: 20%;\n  max-width: fit-content;\n  height: fit-content;\n  overflow: auto;\n  border-radius: 8px;\n  border-style: none;\n  background-color:dodgerblue;\n  padding:0 1rem;\n\n}\n.modalText{\n    padding: 0.5rem;\n    display: flex;\n    flex-direction: column;\n    width: 30rem;\n    color: white;\n    font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n}\n.modalLine{\n    padding: 0;\n    border-style: none;\n}\n.close {\n  color: white;\n  text-align: right;\n  font-size: 28px;\n  font-weight: bold;\n  margin: 0.3rem 0 0 0.7rem;\n}\n\n.close:hover,\n.close:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n"],"sourceRoot":""}]);
// Exports
...
function loadTodos(todoList) {
  ...
  todoList.forEach((element) => {
    ...
    todolist.appendChild(btnDetails);
    btnDetails.addEventListener("click", function () {
      loadTodoDetail(element);
    });
  });
  return todolist;
}
function loadTodoDetail(todo) {
