...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,mBAAmB;EACnB,gBAAgB;EAChB,eAAe;AACjB;AACA;EACE,aAAa;EACb,WAAW;EACX,gBAAgB;AAClB;AACA;EACE,aAAa;EACb,SAAS;EACT,kBAAkB;AACpB;;AAEA;EACE,SAAS;EACT,aAAa;EACb,UAAU;EACV,eAAe;EACf,mBAAmB;EACnB,UAAU;EACV,SAAS;EACT,QAAQ;EACR,kBAAkB;EAClB,mBAAmB;EACnB,cAAc;EACd,kBAAkB;EAClB,mBAAmB;EACnB,mBAAmB;EACnB,iBAAiB;EACjB,4BAA4B;EAC5B,sBAAsB;EACtB,iBAAiB;EACjB,YAAY;EACZ;wEACsE;AACxE;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,kBAAkB;EAClB,4BAA4B;EAC5B,cAAc;EACd,oBAAoB;EACpB,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,WAAW;EACX,aAAa;EACb,sBAAsB;EACtB,oBAAoB;AACtB;AACA;EACE,iBAAiB;EACjB,kBAAkB;AACpB;AACA;EACE,iBAAiB;EACjB,sBAAsB;EACtB,eAAe;EACf,yBAAyB;AAC3B;;AAEA;;;;;;EAME,gBAAgB;EAChB,qBAAqB;EACrB,eAAe;AACjB","sourcesContent":["#content {\n  display: flex;\n}\n\n.project {\n  display: flex;\n  flex-direction: column;\n}\n\n.projName {\n  font-weight: bolder;\n  font-size: large;\n  padding: 0.5rem;\n}\nul {\n  display: flex;\n  width: 6rem;\n  list-style: none;\n}\n.todoList {\n  display: flex;\n  gap: 2rem;\n  text-align: center;\n}\n\n.modal {\n  gap: 2rem;\n  display: flex;\n  flex: auto;\n  position: fixed;\n  align-items: center;\n  z-index: 1;\n  left: 20%;\n  top: 20%;\n  width: fit-content;\n  height: fit-content;\n  overflow: auto;\n  border-radius: 8px;\n  border-style: solid;\n  border-color: white;\n  border-width: 2px;\n  background-color: dodgerblue;\n  padding: 0 1rem 0 2rem;\n  font-weight: bold;\n  color: white;\n  font-family: system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto,\n    Oxygen, Ubuntu, Cantarell, \"Open Sans\", \"Helvetica Neue\", sans-serif;\n}\n\n.btnDetails {\n  color: white;\n  border-radius: 8px;\n  border-style: none;\n  background-color: dodgerblue;\n  margin: 0.2rem;\n  padding: 0.5rem 1rem;\n  height: fit-content;\n}\n.modalText {\n  padding: 1rem;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  font-weight: lighter;\n}\n.modalLine {\n  padding: 0.1rem 0;\n  border-style: none;\n}\n.close {\n  text-align: right;\n  align-self: flex-start;\n  font-size: 28px;\n  margin: 0.3rem 0 0 0.7rem;\n}\n\n.close:hover,\n.close:focus,\n.delete:hover,\n.delete:focus,\n.btnDetails:hover,\n.btnDetails:focus {\n  color: indianred;\n  text-decoration: none;\n  cursor: pointer;\n}\n"],"sourceRoot":""}]);
// Exports
...
function loadTodoDetail(todo , projectName) {
  ...
  deleteButton.addEventListener("click", function () {
    (0,_project__WEBPACK_IMPORTED_MODULE_0__.deleteToDo)(todo.title ,projectName);
    loadAllProjects();
    modal.style.display = "none";
  });
...
(0,_loadData__WEBPACK_IMPORTED_MODULE_0__.loadAllProjects)();
